...
Image correction and segmentation can also configured to run as scheduled jobs on a Linux server. Pertinent description and scripts can be found in repository folder `server`.<br /><br />
