...
Code for batch image processing can be found in sections `#2.1 Batch processing - image correction` and  `2.2 Batch processing - image segmentation`. Both modules make use of the same functions used for single image processing.<br /><br />
