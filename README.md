...
-	In PyCharm, create new project folder named 'neuriteX_root_folder/'
...
-	In `neuriteX.py`, move to section `# 1. Single image analysis` and find the following line of code:<br />
