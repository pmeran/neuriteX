...
Script `neuriteX.R` requires files `df_R1.csv`, `df_R2.csv`, and `df_R3.csv` (see above) to generates charts for neurite integrity scores N_perc, N_perc_corr, and NII (Fig. 3).<br />
<br /><br />
