...
Script `neuriteX.R` generates charts for neurite integrity scores N_perc, N_perc_corr, and NII (Fig. 3), using the above generated files `df_R1.csv`, `df_R2.csv`, and `df_R3.csv`.<br /><br />
